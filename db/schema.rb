...
ActiveRecord::Schema[7.0].define(version: 2023_05_16_144703) do
  ...
  create_table "user_addresses", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.string "user_id"
    t.bigint "region_id_id"
    t.bigint "province_id_id"
    t.bigint "city_id_id"
    t.bigint "barangay_id_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["barangay_id_id"], name: "index_user_addresses_on_barangay_id_id"
    t.index ["city_id_id"], name: "index_user_addresses_on_city_id_id"
    t.index ["phone_number_id"], name: "index_user_addresses_on_phone_number_id"
    t.index ["province_id_id"], name: "index_user_addresses_on_province_id_id"
    t.index ["region_id_id"], name: "index_user_addresses_on_region_id_id"
  end
